...
public class CurrencyUtils {
    ...
    public static String convertAmountToBulgarianWords(int number) {
        String[] units = {
        ...
        if (number > 19 && number < 100) {
            ...
            if (modularDivision_10 != 0)
                temp += " и " + convertAmountToBulgarianWords(modularDivision_10);
        ...
        if (number > 99 && number < 1_000) {
            ...
            if (modularDivision_100 != 0)
                temp += " " + convertAmountToBulgarianWords(modularDivision_100);

            return temp;
        }

        if (number > 999 && number < 1_000_000) {
            String temp = (division_1_000 == 1) ? "хиляда" : ((division_1_000 == 2) ? "две хиляди" : convertAmountToBulgarianWords(division_1_000) + " хиляди");
            ...
            if (modular_division_1_000 != 0)
                temp += " " + convertAmountToBulgarianWords(modular_division_1_000);

            return temp;
        }

        if (number > 999_999 && number < 1_000_000_000) {
            String tmp = (division_1_000_000 == 1) ? "един милион" : convertAmountToBulgarianWords(division_1_000_000) + " милиона";
            ...
            if (modular_division_1_000_000 != 0)
                tmp += " " + convertAmountToBulgarianWords(modular_division_1_000_000);
        ...
        if (number > 999_999_999 && number <= 2_000_000_000) {
            ...
            if (modular_division_1_000_000_000 != 0)
                tmp += " " + convertAmountToBulgarianWords(modular_division_1_000_000_000);
